...
const Dashboard = () => {
  ...
  const items = [
    getItem(<Link to="/">Giám sát</Link>, "1", <PieChartOutlined />, null, "/"),
    getItem(
    ...
    getItem("Quản lý", "sub1", <WalletOutlined />, [
      getItem("Cán bộ", "sub1-1", null, [
        getItem(<Link to="/drivers">Lái xe</Link>, "3", null, null, "/drivers"),
        getItem(
      ...
      getItem(<Link to="/rfids">Thẻ RFID</Link>, "10", null, null, "/rfids"),
      getItem(
    ...
    getItem("Người dùng", "sub1-3", <UserOutlined />, [
      getItem(<Link to="/users">Tài khoản</Link>, "8", null, null, "/users"),
      getItem(
      ...
      getItem(<Link to="/units">Đơn vị</Link>, "15", null, null, "/units"),
    ]),
